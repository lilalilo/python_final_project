...
if __name__ == '__main__':
    ...
    parser.add_argument('--training_buffer_size', type=int, default=6000000,
                         help='number of patches in the training buffer')

    parser.add_argument('--samples_per_image', type=int, default=768,
    ...
    parser.add_argument('--debug_context', type=bool, default=False)
